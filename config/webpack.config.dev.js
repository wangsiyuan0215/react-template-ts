...
module.exports = {
    ...
    resolve: {
        ...
        alias: {
            ...
            components: path.resolve(paths.appSrc, 'components/index.ts'),
            languages: path.resolve(paths.appSrc, 'languages/index.ts'),
            models: path.resolve(paths.appSrc, 'models'),
            resources: path.resolve(paths.appSrc, 'resources/index'),
